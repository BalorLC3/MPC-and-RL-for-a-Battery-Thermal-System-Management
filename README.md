...
| ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| <img src="results/thermostat_controller.png" width="200" alt="Thermostat Controller"><br>*Baseline heuristic controller* | <img src="results/dp_controller.png" width="200" alt="DP Controller"><br>*Non-causal optimal benchmark* | <img src="results/smpc_controller.png" width="200" alt="SMPC Controller"><br>*Stochastic MPC under uncertainty* | <img src="results/sac_h0_controller.png" width="200" alt="SAC Controller"><br>*Soft Actor-Critic (model-free RL)* |
